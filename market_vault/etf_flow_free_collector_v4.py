...
def collect(asset:str)->dict[str,Any]:
    ...
    return {
      ...
      'flow_3d_usd_m':w(3),'flow_5d_usd_m':w(5),'flow_7d_usd_m':w(7),'flow_20d_usd_m':w(20),
...
def main():
    ...
    p={'engine':'MASTER_MARKET_FREE_ETF_FLOW_V1','schema_version':'1.4','generated_at_utc':now_iso(),'score_weight':0,'role':'Free public ETF-flow evidence for existing MASTER MARKET institution-flow axis.','windows':['1D','3D','5D','7D','20D'],'assets':assets,'failures':fail}
